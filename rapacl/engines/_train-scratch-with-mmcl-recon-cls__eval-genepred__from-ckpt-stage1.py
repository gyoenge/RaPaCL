...
# radiomics transtab : train 
# pathomics img encoder : freeze (densenet121 pretrained)

# Train: Losses 
# - transtab [Contrastive] & img encoder [CLS] -> pathomics-radiomcis contrastive loss 
# - transtab [Contrastive] -> radiomics reconstruction loss 
# - transtab [CLS] -> radiomics cell-type classificaion (5 classes)

# Eval: Gene prediction
# - train: concat(pathomics [CLS], radiomics [Contrastive]) -> genehead -> gene prediction MSE loss 
# - evaluate with gene-wise PCC mean score 
