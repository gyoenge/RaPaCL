...
def fit_fold(
    ...
    if cfg.include_val_in_train:
        ...
        print(f"effective_pretrain_val_df: {effective_pretrain_val_df.shape}")
    else:
    ...
    train_emb = compute_embeddings_df(extractor, effective_train_df, feature_cols, cfg.eval_batch_size)
